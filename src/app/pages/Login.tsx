    ...
    <div className="min-h-screen bg-[#F5F6FA] flex flex-col items-center justify-center px-4">
      ...
      <div className="text-center mb-8">
        <div className="flex items-center justify-center gap-2 mb-3">
          ...
          <span className="text-indigo-600" style={{ fontSize: 24, fontWeight: 700 }}>
            TalentSol
          </span>
        </div>
      ...
      <div className="w-full max-w-sm bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
        <h2 className="text-gray-900 mb-1" style={{ fontSize: 20, fontWeight: 600 }}>
          Login
        </h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex items-center gap-2">
            ...
            />
            <label htmlFor="remember" className="text-gray-600 cursor-pointer" style={{ fontSize: 13, fontWeight: 400 }}>
              Remember me
            </label>
          </div>
          ...
          <button
            type="submit"
            className="w-full py-2.5 bg-indigo-600 hover:bg-indigo-700 text-white rounded-lg transition-colors"
        ...
        <p className="text-center mt-5 text-gray-500" style={{ fontSize: 13 }}>
          ...
          <button className="text-indigo-600 hover:text-indigo-700" style={{ fontWeight: 500 }}>
            Sign up
          </button>
        </p>
